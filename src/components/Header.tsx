            ...
            <div className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl tracking-wider leading-none flex items-end">
              <span className="flex items-center">
                ...
                <button
                  ...
                  className="hover:opacity-80 transition-opacity duration-200 cursor-pointer mx-2 sm:mx-3"
          ...
          <nav className="flex justify-center items-center gap-1 sm:gap-4 lg:gap-6 max-w-4xl mx-auto px-1 py-0.5 sm:py-0 overflow-x-auto font-montserrat">
            {['Home', 'Services', 'About', 'Gallery', 'Contact'].map((item) => (
              <button
                ...
                className="text-gray-700 hover:text-olive active:text-olive active:bg-olive/20 transition-colors duration-200 font-medium cursor-pointer px-1 sm:px-3 py-1.5 sm:py-2 rounded-lg hover:bg-olive/10 focus:outline-none focus:text-olive text-xs sm:text-base whitespace-nowrap flex-shrink-0 select-none min-h-[44px] flex items-center"
              >
                {item}
              </button>
            ))}
