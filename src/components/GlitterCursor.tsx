...
function OriginkitBaseStarCursor(props: StarCursorProps) {
  ...
  useEffect(() => {
    ...
    const emit = (now: number) => {
      ...
      const attr = mouseAttr as THREE.BufferAttribute & {
...
export default function GlitterCursor(props: Record<string, unknown>) {
  return <OriginkitBaseStarCursor {...(originkitPresetProps as Record<string, unknown>)} {...props} />;
}
